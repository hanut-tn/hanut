-- customer_landmark devient optionnel dans create_order_with_items.
-- Supprime le guard "Repere livreur obligatoire" (le seul changement par rapport à 20260717).
-- La colonne customer_landmark est déjà TEXT (nullable) sur orders, customers et customer_addresses.
...
BEGIN
  ...
  THEN
    ...
    -- customer_landmark intentionnellement optionnel : suppression du guard ci-dessous
