-- Certains projets existants ont activity_logs.entity_id en UUID, alors que
-- le schéma courant le définit en TEXT. La comparaison via ::TEXT fonctionne
-- avec les deux types et permet de nettoyer les journaux sans bloquer la RPC.
