-- Rejeter p_delta = 0 pour éviter les mouvements de stock no-op dans l'historique.
-- Copie complète de adjust_product_stock avec uniquement ce guard ajouté.
...
BEGIN
  ...
  IF p_delta = 0 THEN
    RAISE EXCEPTION 'INVALID_DELTA:Le delta ne peut pas être zéro';
  END IF;
