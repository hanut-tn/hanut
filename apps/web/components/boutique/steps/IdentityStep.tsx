...
import { ImagePlus, Sunset } from 'lucide-react'
...
export default function IdentityStep({ shopInfo, onChange, logoUploading, bannerUploading, onLogoFile, onBannerFile }: Props) {
