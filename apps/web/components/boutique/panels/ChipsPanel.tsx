...
import type { StorefrontChips, PopoverPosition } from '@hanut/types'
...
export default function ChipsPanel({ chips, onChange, position, onClose }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="p-4">
        <ChipsSection chips={chips} onChange={onChange} />
      </div>
    </div>
  )
}
