...
const PLANS: Plan[] = [
  {
    ...
    features: [
      '100 commandes / mois',
      'Mini boutique publique /s/votre-slug',
      '1 template visuel (Mode)',
      'Catalogue illimité',
      ...
      'Analytics 30 jours',
      'Support WhatsApp',
      'Branding "Propulsé par Hanut" visible',
    ],
    cta: 'Choisir Starter',
  },
  {
    ...
    features: [
      ...
      'Mini boutique SANS branding Hanut',
      '4 templates visuels (Mode, Luxe, Fresh, Dark)',
      'Couleur, logo et bannière personnalisés',
      'Tout le Starter inclus',
      'Historique mouvements stock',
      'CRM clients (tags, notes)',
      'Export CSV',
      'Analytics 180 jours + comparaison',
      'Top produits, clients, villes',
...
const COMPARE_ROWS = [
  { label: 'Commandes / mois', values: ['100', 'Illimitées', 'Bientôt'] },
  { label: 'Template boutique', values: ['1', '4', 'Bientôt'] },
  { label: 'Couleur & logo personnalisés', values: ['—', '✓', 'Bientôt'] },
  { label: 'Sans branding Hanut', values: ['—', '✓', 'Bientôt'] },
  { label: 'Analytics', values: ['30 jours', '180 jours', 'Bientôt'] },
  { label: 'Historique mouvements stock', values: ['—', '✓', 'Bientôt'] },
  { label: 'Fiche client CRM (tags/notes)', values: ['—', '✓', 'Bientôt'] },
...
function BusinessWaitlist() {
  ...
  if (done) {
    return (
      <p className="text-center text-sm text-gray-500 py-3">Vous serez notifié dès l&apos;ouverture du plan Business.</p>
    )
  }
