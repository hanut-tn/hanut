...
export const DELETABLE_STATUSES: OrderStatus[] = ['pending', 'new', 'confirmed', 'cancelled']
...
export const PLAN_LIMITS = {
  starter: {
    // ⚠️ Synchronisé avec la constante 100 dans supabase/migrations/20260620000000_secure_order_rpc.sql
